...
var content_view_stub_1 = __webpack_require__(329);
(function main() {
    var blueContentViewStub = new content_view_stub_1.ContentViewStub(document, 'blue');
    var oprViewContainer = document.body.querySelector('#oprviewcontainer');
    if (oprViewContainer != null) oprViewContainer.appendChild(blueContentViewStub.getHtmlRootElement());
...
Object.defineProperty(exports, "__esModule", { value: true });
var ContentViewStub = /** @class */function () {
    function ContentViewStub(domDoc, backgroundColor) {
        this._rootElement = domDoc.createElement('div');
        this._rootElement.style.backgroundColor = backgroundColor;
    }
    ContentViewStub.prototype.getHtmlRootElement = function () {
        return this._rootElement;
    };
    return ContentViewStub;
}();
exports.ContentViewStub = ContentViewStub;
