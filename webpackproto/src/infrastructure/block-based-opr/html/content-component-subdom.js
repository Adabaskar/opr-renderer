...
/**
 * Interface deklaring how a content renderer has to look like.
 */
class ContentComponentSubDOM {
    constructor() {

        /**
         * returns the root of the Sub Dom tree managed by this component
         * 
         */
        this.getRootNode = function () {
            throw new Error("interface, derive from it do not use directly");
        }
    }
}
module.exports = ContentComponentSubDOM;